...
<body>
    ...
    <?php
        ...
        //criando insert
        $insert = "insert into pessoas( id, nome, cpf, rg, ende, tel, email, social, val_emp, data_emp, juros, data_dev, val_dev, sobrenome, detalhes, pagamento, situacao, parcelas, parcelas_pagas) 
        values($id, '$nome', '$cpf', '$rg', '$ende', '$tel', '$email', '$social', $val_emp, '$data_emp', $juros, '$data_dev', $val_dev, '$sobrenome', '$detalhes', '$pagamento', '$situacao', '$parcelas', '$parcelas_pagas')";
