...
$Pedido = mysqli_query($conexao, "SELECT * from pedidos where n_pedido='$n_pedido'");
$pedido = mysqli_fetch_array($Pedido);
?>
    ...
    <div class="container">
        ...
        <form action="" id="EditProdutoForm">
            ...
            <div class="form__group">
                <input type="text" disabled class="form__field" value="<?= $pedido['nome_c'] ?>" required="">
                <label for="name" class="form__label">Nome</label>
            </div>
            <div class="form__group">
                <input type="text" disabled class="form__field" required="" value="<?= $pedido['user_name'] ?>">
                <label for="name" class="form__label">Usuário</label>
            </div>
            <div class="form__group">
                <input type="text" disabled class="form__field" required="" value="<?= $pedido['email'] ?>">
                <label for="name" class="form__label">Email</label>
            </div>

            <div class="form__group">
                <input type="text" disabled class="form__field" required="" value="<?= $pedido['tel_c'] ?>">
                <label for="name" class="form__label">Celular</label>
            </div>
            <div class="form__group">
                <input type="text" disabled class="form__field" required="" value="<?= $pedido['cpf_c'] ?>">
...
<!-- 
            ...
            <div class="form__group">
                <input type="text" disabled class="form__field" placeholder="Name" required="" value="<?= $pedido['codP'] ?>">
